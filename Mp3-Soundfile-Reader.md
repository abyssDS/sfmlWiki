...
Uses sf::SoundFileFactory::registerReader<SoundFileReader>() to properly register the reader for mp3 format.

View on github: https://github.com/hansiC/sfml-soundfileReader-example
