...
* Update your `PATH` environment variable to include the following paths:
  ...
  * *[Path to Git]*/bin
  * *[Path to SDK]*/tools
    * Note: On macOS, this can be found at /Users/[Username]/Library/Android/sdk/tools
  * *[Path to SDK]*/platform-tools
    * Note: On macOS, this can be found at /Users/[Username]/Library/Android/sdk/platform-tools
  * *[Path to NDK]*
  * *[Path to ANT]*/bin
