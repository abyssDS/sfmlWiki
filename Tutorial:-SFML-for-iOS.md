...
* Xcode, available on the Mac App Store
  * Important: If Xcode is not installed in a directory that contain spaces (with the exception of your normal boot drive, _Macintosh HD_ or _Macintosh SSD_), you will later encounter errors when using CMake. Its standard installation directory (_/Applications_) will work fine.
...
Next, click on the "Add Entry" button, and a BOOL named `IOS` and check the "Value" textbox, and press OK.  
